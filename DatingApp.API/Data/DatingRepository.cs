...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<IEnumerable<Message>> GetMessageThred(int userId, int receptientId)
        {
            var messages = await _context.Messages.Where(m => m.RecipientId == userId && m.RecipientDeleted==false && m.SenderId == receptientId 
            || m.RecipientId == receptientId && m.SenderDeleted==false && m.SenderId ==userId)
